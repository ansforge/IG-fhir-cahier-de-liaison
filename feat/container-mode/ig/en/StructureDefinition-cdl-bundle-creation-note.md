# Bundle de création d'une note - Cahier De Liaison v3.0.0
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-06-26T11:42:02+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://interop.esante.gouv.fr/ig/fhir/cdl/StructureDefinition/cdl-bundle-creation-note"
      }]
    },
    {
